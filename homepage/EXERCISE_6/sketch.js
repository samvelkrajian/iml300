// In this exercise, I assembled what would be one of the pages in my website, using the information I learned from the classes and objects video and slides. I have created "particles" out of harmful tweet by Azerbaijani political leaders. The user also has the ability to drag their mouse across the page, and draw more tweets.
